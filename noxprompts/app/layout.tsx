...
export const metadata: Metadata = {
  ...
  keywords: 'AI prompts, trending AI art, Ghibli prompts, anime AI art, Midjourney prompts, ChatGPT image prompts',
  openGraph: {
    title: 'NoxPrompts — Trending AI Art Prompts',
  ...
  return (
    <html lang="en" suppressHydrationWarning>
      <head>
        ...
        <link
          href="https://fonts.googleapis.com/css2?family=Space+Grotesk:wght@300;400;500;600;700&family=Unbounded:wght@400;700;900&display=swap"
          rel="stylesheet"
        />
      </head>
